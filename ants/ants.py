...
# max range< 4 entrance transitions
# inherit nearest_bee method 
    name = 'Short'
    food_cost = 2
    min_range = 0
    max_range = 3
    ...
    # BEGIN Problem 4
    implemented = True 
    def short(self, nearest_bee):
        if nearest_bee.place in super().min_range:
            return super().throw_at(ThrowerAnt, nearest_bee)
        return None
    # END Problem 4
...
# min range > 4 entrance transitions
    name = 'Long'
    food_cost = 2
    min_range = 5
    max_range = float('inf')
    ...
    # BEGIN Problem 4
    implemented = True   
    def long(self, nearest_bee):
        if nearest_bee.place in super().max_range:
            return super().throw_at(ThrowerAnt, nearest_bee)
        return None
    # END Problem 4
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        for bees in lst_of_bees:
            bees.reduce_health(actual_damage)
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    def eat_bee(self,bee):
        og_health = bee.health 
        Insect.reduce_health(bee,og_health)
    ...
    def action(self, gamestate):
        ...
        if self.chew_timer == 0:
            if random_bee(current_place.bees):
                return self.eat_bee(random_bee(current_place.bees))
        else:
            self.chew_timer -= 1
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        """
        # BEGIN Problem 12
        place_rn = self.place.exit
        super().action(gamestate)
        while place_rn.exit != None:
            if place_rn.ant:
                if place_rn.ant.is_container and place_rn.ant.ant_contained:
                    place_rn.ant.ant_contained.double()
                    place_rn.ant.double()
                place_rn.ant.double()
            place_rn = place_rn.exit
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        if self.scared_length > 0 and self.slow_length > 0:
            self.slow_length -= 1
            if gamestate.time % 2 == 0:
                ...
                return None
        elif self.slow_length > 0:
            self.slow_length -= 1
            if gamestate.time % 2 != 0:
                return None
        elif self.scared_length > 0:
